 ...
 */
function execAPI(command, args = [], options = {}, _category = 'general') {
 ...
 */
async function createTestEnvironment(testName, _category = 'general') {
 ...
 */
function generateTestFeature(overrides = {}, _category = 'general') {
  return {
