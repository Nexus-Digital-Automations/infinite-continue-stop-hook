...
describe('NodeModulesMonitor', () => {
    ...
    function createMockCriticalFiles() {
        ...
        fs.writeFileSync(path.join(mockNodeModules, 'exit', 'package.json'), 
            JSON.stringify({ name: 'exit', version: '0.1.2' }, null, 2));
        fs.writeFileSync(path.join(mockNodeModules, 'jest-worker', 'package.json'), 
