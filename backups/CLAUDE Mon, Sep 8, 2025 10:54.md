...
**TRIGGERS:** User requests, linter errors (highest priority), build-blocking failures, runtime bugs, security vulnerabilities, spotted opportunities
...
- **✅ CONTINUATION OVER CREATION** - Always check for incomplete work before starting anything new
- **✅ PERSISTENCE THROUGH CHALLENGES** - Work through difficulties rather than abandoning tasks
- **✅ CONTEXT PRESERVATION** - When resuming work, maintain previous implementation approaches
- **❌ NO TASK HOPPING** - Never jump between incomplete tasks unless absolutely necessary - maintain focus
- **❌ NO ABANDONMENT** - Never leave tasks partially complete without documentation - this is unprofessional
- **❌ NO RESTART FROM SCRATCH** - Build upon existing work rather than wasting previous effort
...
- **RESUME INCOMPLETE WORK** - Always check for and continue incomplete tasks before starting new ones - respect prior effort
- **COMPLETION VERIFICATION** - Verify task completion with evidence before moving to next task - deliver quality
- **SEAMLESS CONTINUATION** - When resuming interrupted work, continue as if no interruption occurred
- **WORK CONTEXT PRESERVATION** - Maintain implementation approaches and architectural decisions from previous work
- **PROFESSIONAL PERSISTENCE** - Push through challenges and validation failures to complete tasks
- **HANDOFF DOCUMENTATION** - If forced to switch tasks, document exactly where work was left off
...
4. **ANALYZE EXISTING PROGRESS** - Understand what was completed, what remains, what challenges exist
5. **PRESERVE IMPLEMENTATION APPROACH** - Continue with established patterns and architectural decisions
6. **PUSH THROUGH TO COMPLETION** - Work through validation failures, fix issues, complete the task
7. **IF NO CURRENT TASK**: Check for next available task and claim highest priority
8. **TASK COMPLETION DISCIPLINE** - Never start new tasks while current work remains incomplete - professional discipline
9. **EVIDENCE-BASED CONTINUATION** - Verify what was completed and what remains for current task
...
- **IMPLEMENTATION CONTINUITY** - Maintain established code patterns, variable names, and architectural decisions
- **PROGRESS DOCUMENTATION** - If forced to interrupt, document exactly what was completed and what remains
- **EVIDENCE TRAIL** - Maintain clear evidence of task progress and completion for accountability
- **ONE TASK FOCUS** - Maintain single-task focus until completion unless critical interruption occurs - professional discipline
- **PERSISTENCE THROUGH DIFFICULTIES** - Work through validation failures and technical challenges rather than abandoning
- **COMPLETION COMMITMENT** - Treat task completion as a professional obligation to teams and users
- **WORKFLOW INTEGRITY** - Maintain consistent work patterns and avoid task-switching inefficiencies
