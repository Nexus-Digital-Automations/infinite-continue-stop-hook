...
class SubtasksManager {
   ...
   */
  createSubtask(taskId, subtaskData, agentId = 'unknown') {
   ...
   */
  _findSubtaskByIdAcrossTasks(subtaskId) {
    try {
   ...
   */
  updateSubtaskWithSecurity(subtaskId, updateData, agentId = 'unknown') {
    try {
   ...
   */
  deleteSubtaskWithSecurity(subtaskId, agentId = 'unknown') {
    try {
