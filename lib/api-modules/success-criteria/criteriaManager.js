...
class SuccessCriteriaManager {
  /**
   * Initialize enhanced SuccessCriteriaManager
  ...
  constructor(dependencies) {
    ...
    if (this.enableLogging) {
      this.logger.info?.('Enhanced SuccessCriteriaManager initialized', {
        features: {
  ...
  _logOperation(operation, data) {
    if (this.enableLogging) {
      this.logger.info?.(`SuccessCriteriaManager.${operation}`, data);
    }
  }
  ...
  _logError(operation, error, context = {}) {
    if (this.enableLogging) {
      this.logger.error?.(`SuccessCriteriaManager.${operation} failed`, {
        error: error.message,
        stack: error.stack,
        context,
      });
