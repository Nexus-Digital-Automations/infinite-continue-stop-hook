...
module.exports = {
  ...
  /**
   * Create a fully configured SuccessCriteriaManager instance
   ...
   * @returns {SuccessCriteriaManager} Configured manager instance
   */
  createManager(dependencies, options = {}) {
    ...
    const validationEngine = new _ValidationEngine({
