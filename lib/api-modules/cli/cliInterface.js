 ...
 */
async function executeCommand(api, args, category = 'general') {
  ...
  try {
    ...
    throw await enhanceErrorWithContext(api, _error, command);
  }
}
...
async function _handleInitCommand(api, args) {
  ...
  if (args[1]) {
    try {
      ...
      throw new Error(`Invalid JSON configuration: ${_error.message}`);
    }
 ...
 */
  async function _handleStatusCommand(api, args) {
    ...
    const result = await api.getAgentStatus(AGENT_ID);
    loggers.stopHook.log({ additionalData: [null, 2] }, JSON.stringify(result));
    loggers.app.info(JSON.stringify(result, null, 2));
  }
 ...
 */
  async function _handleCurrentCommand(api, args) {
    ...
    const result = await api.getCurrentTask(AGENT_ID);
    loggers.stopHook.log({ additionalData: [null, 2] }, JSON.stringify(result));
    loggers.app.info(JSON.stringify(result, null, 2));
  }
  ...
  async function _handleListCommand(api, args) {
    ...
    if (args[1]) {
      try {
        ...
        throw new Error(`Invalid JSON filter: ${_error.message}`);
      }
    }
 ...
 */
  async function _handleCreateCommand(api, args) {
    ...
    try {
      ...
      throw new Error(`Invalid JSON task data: ${_error.message}`);
    }
 ...
 */
  async function _handleClaimCommand(api, args, agentId) {
    const taskId = args[1];
    let agentId = args[2];
  ...
  async function _handleCompleteCommand(api, args) {
    ...
    if (args[2]) {
      try {
        ...
        throw new Error(`Invalid JSON completion data: ${_error.message}`);
      }
    }
 ...
 */
  async function _handleSuggestFeatureCommand(api, args) {
    ...
    try {
      ...
      throw new Error(`Invalid JSON feature data: ${_error.message}`);
    }

    const AGENT_ID = null;
    const result = await api.suggestFeature(FEATURE_DATA, AGENT_ID);
    loggers.stopHook.log({ additionalData: [null, 2] }, JSON.stringify(result));
    loggers.app.info(JSON.stringify(result, null, 2));
  }
 ...
 */
  async function _handleCreatePhaseCommand(api, args) {
    ...
    try {
      ...
      throw new Error(`Invalid JSON phase data: ${_error.message}`);
    }
 ...
 */
  async function _handleUpdatePhaseCommand(api, args) {
    ...
    try {
      ...
      throw new Error(`Invalid JSON update data: ${_error.message}`);
    }
  ...
  async function _handleGetTasksCommand(api, args) {
    ...
    if (args[1]) {
      try {
        ...
        throw new Error(`Invalid JSON options: ${_error.message}`);
      }
    }
  ...
  async function _handleCreateSubtaskCommand(api, args) {
    ...
    if (args[3]) {
      try {
        ...
        throw new Error(`Invalid JSON subtask data: ${_error.message}`);
      }
    }
 ...
 */
  async function _handleAddSuccessCriteriaCommand(api, args) {
    ...
    try {
      ...
      throw new Error(`Invalid JSON criteria data: ${_error.message}`);
    }
  ...
  async function _handleValidateCriteriaCommand(api, args) {
    ...
    if (args[3]) {
      try {
        ...
        throw new Error(`Invalid JSON evidence data: ${_error.message}`);
      }
    }
  ...
  async function _handleResearchTaskCommand(api, args) {
    ...
    if (args[3]) {
      try {
        ...
        throw new Error(`Invalid JSON research data: ${_error.message}`);
      }
    }
  ...
  async function _handleAuditTaskCommand(api, args) {
    ...
    if (args[3]) {
      try {
        ...
        throw new Error(`Invalid JSON audit data: ${_error.message}`);
      }
    }
 ...
 */
  async function _handleStoreLessonCommand(api, args) {
    ...
    try {
      ...
      throw new Error(`Invalid JSON lesson data: ${_error.message}`);
    }
 ...
 */
  async function _handleStoreErrorCommand(api, args) {
    ...
    try {
      ...
      throw new Error(`Invalid JSON _error data: ${_error.message}`);
    }
 ...
 */
  function displayHelp(agentId, category = 'general') {
    loggers.app.info(`
