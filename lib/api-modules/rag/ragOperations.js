...
`.trim();
  ...
  async cleanupObsoleteLessons(options = {}) {
    try {
      ...
      return {
        ...
        message: result.message || 'Cleanup operation completed',
        ragSystem: 'active',
      };
  ...
  async detectLearningPatterns(options = {}) {
    try {
      ...
      const result = await this.withTimeout(
        this.learningPatternDetection.detectPatterns(options),
        10000,
      );
  ...
  async getPatternBasedSuggestions(context, options = {}) {
    try {
      ...
      const result = await this.withTimeout(
        this.learningPatternDetection.generateLessonSuggestions(context, options),
        10000,
      );
  ...
  async analyzeLessonPatterns(lessonId, options = {}) {
    try {
      ...
      const result = await this.withTimeout(
        this.learningPatternDetection.analyzeLessonPatterns(lessonId, options),
        10000,
      );
      ...
      return {
        ...
        message: result.message || 'Lesson pattern analysis completed',
        ragSystem: 'active',
      };
  ...
  async clusterPatterns(options = {}) {
    try {
      ...
      const result = await this.withTimeout(
        this.learningPatternDetection.clusterPatterns(options),
        10000,
      );
      ...
      return {
        ...
        cluster_count: result.cluster_count || 0,
        pattern_relationships: result.pattern_relationships || [],
        similarity_matrix: result.similarity_matrix || {},
        dominant_clusters: result.dominant_clusters || [],
        cluster_insights: result.cluster_insights || [],
        message: result.message || 'Pattern clustering completed successfully',
        ragSystem: 'active',
      };
  ...
  async searchSimilarPatterns(query, options = {}) {
    try {
      ...
      const result = await this.withTimeout(
        this.learningPatternDetection.searchSimilarPatterns(query, options),
        10000,
      );
      ...
      return {
        ...
        message: result.message || 'Similar pattern search completed',
        ragSystem: 'active',
      };
  ...
  async generatePatternInsights(options = {}) {
    try {
      ...
      const result = await this.withTimeout(
        this.learningPatternDetection.generateInsights(options),
        10000,
      );
      ...
      return {
        ...
        system_improvements: result.system_improvements || [],
        learning_gaps: result.learning_gaps || [],
        pattern_strengths: result.pattern_strengths || [],
        confidence_assessment: result.confidence_assessment || {},
        message: result.message || 'Pattern insights generated successfully',
        ragSystem: 'active',
      };
  ...
  async updatePatternDetectionConfig(configUpdates) {
    try {
      ...
      const result = await this.withTimeout(
        this.learningPatternDetection.updateConfiguration(configUpdates),
        10000,
      );
      ...
      return {
        ...
        message: result.message || 'Pattern detection configuration updated successfully',
        ragSystem: 'active',
      };
