...
**Recommended Action:**
Run linter checks on the files/directories you modified:

${directories.map(dir => `\`npm run lint ${dir}\``).join('\n')}

Or run a full project lint check:
\`npm run lint\`

This will help ensure code quality and catch any style issues in your recent work.`;
    }
