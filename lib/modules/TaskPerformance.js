...
class TaskPerformance {
  ...
  recordQueryTime(operation, duration, metadata = {}) {
    ...
    const currentCount = this._metrics.operationCounts.get(_operation) || 0;
    ...
    if (this._isOperationConsistentlySlow(_operation)) {
   ...
   * @private
   */
  _isOperationConsistentlySlow(_operation) {
