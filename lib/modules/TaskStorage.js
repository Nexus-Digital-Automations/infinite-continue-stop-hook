  ...
  listBackups() {
    ...
    try {
      ...
      const backupFiles = files
        ...
        .map(file => {
          const _filePath = path.join(todoDir, file);
          // eslint-disable-next-line security/detect-non-literal-fs-filename -- _filePath constructed from validated directory structure
