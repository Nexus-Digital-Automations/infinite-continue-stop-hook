...
class CentralizedLogger {
  ...
  formatMessage(level, message, data = null) {
    ...
    // eslint-disable-next-line security/detect-object-injection -- Array access with validated numeric log level for message formatting
    ...
    if (!this.silent) {
      switch (level) {
        case LOG_LEVELS.ERROR:
          // eslint-disable-next-line no-console -- Logger utility console output for structured error logging
          console.error(formattedMessage);
          break;
        case LOG_LEVELS.WARN:
          // eslint-disable-next-line no-console -- Logger utility console output for structured warning logging
          console.warn(formattedMessage);
          break;
        case LOG_LEVELS.INFO:
          // eslint-disable-next-line no-console -- Logger utility console output for structured info logging
          console.log(formattedMessage);
          break;
        case LOG_LEVELS.DEBUG:
          // eslint-disable-next-line no-console -- Logger utility console output for structured debug logging
          console.log(formattedMessage);
          break;
        default:
          // eslint-disable-next-line no-console -- Logger utility console output for structured default logging
          console.log(formattedMessage);
      }
    }
  }
