...
class RAGSystemTest {
  ...
  testLessonOperations(category = 'general') {
    loggers.app.info('\n📝 Testing Lesson Operations...');
  ...
  testRAGOperationsIntegration(category = 'general') {
    loggers.app.info('\n🔗 Testing RAG Operations Integration...');
  ...
  cleanup() {
    try {
      ...
      try {
        ...
        loggers.app.warn('Cleanup warning:', _error.message);
      }
  }
}
