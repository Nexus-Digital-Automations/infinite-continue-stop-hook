...
class VectorEmbeddingManager {
   ...
   */
  async searchWithDatabase(entityType, queryVector, limit, threshold) {
    try {
    ...
    try {
      ...
      const cleanupPromises = cacheFiles.map(async (file) => {
        try {
          ...
          // eslint-disable-next-line security/detect-non-literal-fs-filename -- Cache file path validated above
