...
class LintingErrorFixer {
  ...
  fixFile(filePath) {
    try, {
      ...
      const varPatterns = [
        { declared: '_filePath', used: 'filePath' },
        { declared: '_result', used: 'result' },
        { declared: '_error', used: 'error' },
        { declared: '_output', used: 'output' },
      ...
      const unusedVars = [
        { name: 'filePath', prefix: '_filePath' },
        { name: 'error', prefix: '_' },
        { name: 'result', prefix: '_result' },
        { name: 'output', prefix: '_output' },
        { name: 'match', prefix: '_match' },
