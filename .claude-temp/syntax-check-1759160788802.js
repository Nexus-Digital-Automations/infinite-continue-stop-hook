...
class TimingReportsGenerator {
  ...
  async _loadMetricsData() {
    ...
    try {
      ...
      loggers.stopHook.warn('Could not load enhanced metrics:', error.message);
    }
    ...
    try {
      ...
      loggers.stopHook.warn('Could not load legacy metrics:', error.message);
      loggers.app.warn('Could not load legacy metrics:', error.message);
    }
