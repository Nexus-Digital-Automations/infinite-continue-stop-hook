...
class SecretManager {
  ...
  async initialize(options = {}) {
    ...
    try {
      ...
      logger.info({
        ...
        validSecrets: VALIDATION_RESULTS.valid.length,
        invalidSecrets: VALIDATION_RESULTS.invalid.length,
        missingRequired: VALIDATION_RESULTS.missingRequired.length,
      ...
      logger.error({ error: error.message }, 'Failed to initialize Secret Manager');
      throw error;
    }
  }
  ...
  async _rotateAWSSecret(key) {
    try {
      ...
      logger.error({ key, error: error.message }, 'AWS secret rotation failed');
      return false;
    }
  }
  ...
  async _rotateVaultSecret(key) {
    try {
      ...
      logger.error({ key, error: error.message }, 'Vault secret rotation failed');
      return false;
    }
  }
  ...
  async _rotateDopplerSecret(key) {
    try {
      ...
      logger.error({ key, error: error.message }, 'Doppler secret rotation failed');
      return false;
    }
  }
  ...
  _loadSecretsFromFile() {
    ...
    try {
      ...
      logger.warn({ error: error.message }, 'Failed to load secrets from .env.local');
    }
  }
  ...
  async _loadSecretsFromExternal() {
    ...
    try {
      ...
      logger.warn({ error: error.message }, 'External secret manager loading encountered issues');
    }
  }
  ...
  async _loadFromAWSSecretsManager() {
    ...
    try {
      ...
      logger.warn({ error: error.message }, 'Failed to load from AWS Secrets Manager');
    }
  }
  ...
  async _loadFromHashiCorpVault() {
    ...
    try {
      ...
      logger.warn({ error: error.message }, 'Failed to load from HashiCorp Vault');
    }
  }
  ...
  async _loadFromDoppler() {
    ...
    try {
      ...
      logger.warn({ error: error.message }, 'Failed to load from Doppler');
    }
  }
  ...
  async _loadFromKubernetesSecrets() {
    ...
    try {
      ...
      logger.warn({ error: error.message }, 'Failed to load from Kubernetes secrets');
    }
  }
...
async function validateRequiredSecrets(requiredSecrets = []) {
  try {
    ...
    logger.error({ error: error.message }, 'Secret validation failed');
