...
const targetedReplacements = [
  ...
  { search: /(\s+)const filePath = /g, replace: '$1const FILE_PATH = ' },
  { search: /(\s+)let filePath = /g, replace: '$1let FILE_PATH = ' },
  { search: /(\s+)const match = /g, replace: '$1const match = ' },
  { search: /(\s+)let match = /g, replace: '$1let match = ' },
  ...
  { search: /\bfilePath\b(?!\w)/g, replace: 'FILE_PATH' },
  { search: /\bmatch\b(?![.\w])/g, replace: 'match' },
