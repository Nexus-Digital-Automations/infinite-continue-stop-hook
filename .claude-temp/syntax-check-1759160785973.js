...
const relevanceScore =
   ...
   */
  getSharedLessonsForProject(projectId, options = {}) {
    try {
      await this.initialize();
    const {
...
const relevancePromises = sharedLessons.map(async lesson => {
    ...
    success: true,
      ...
      if (include_recommendations) {
        ...
        result.recommendations = recommendations.success ? recommendations.recommendations : [];
      }
   ...
   */
  getProjectRecommendations(projectId, options = {}) {
    try {
      await this.initialize();
    const {
...
const [topCategories] = await this.db.query(`
   ...
   */
  _generateSharingRecommendations(lessonId, sourceProjectId) {
    try {
...
const dbOperations = [];
    ...
    recommendation_id: recommendationId,
      ...
      // Use structured logging For _error reporting;,
