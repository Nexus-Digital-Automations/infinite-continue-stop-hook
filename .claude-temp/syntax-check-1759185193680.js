...
const [fileResults, dirResults] = await Promise.all([
  ...
  analyzeFile(filePath, focus) {
    ...
    try {
      ...
      // API extraction
      analysis.apis = this.extractAPIs(content, FILE_PATH);

      // Documentation extraction
      analysis.documentation = this.extractDocumentation(content, FILE_PATH);

      // Dependency analysis
      analysis.dependencies = this.analyzeDependencies(content, FILE_PATH);
