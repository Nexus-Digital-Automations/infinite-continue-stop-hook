...
class DatabaseManager {
  ...
  async initialize() {
    try {
      ...
      throw new Error(`Database initialization failed: ${_.message}`);
    }
}
...
const validatedSchemaPath = DatabaseSecurityHelper.validateDbPath(this.schemaPath);
      ...
      throw new Error(`Failed to apply schema: ${_.message}`);
    }
}
...
const projectExists = await this.get(
      ...
      this.log('warn', 'Failed to initialize default data:', _.message);
    }
}
